...
$adminSections = [
    ...
    [
        ...
        'cards' => [
            ...
            ['title' => 'TM Ranking Access', 'desc' => 'Activate Event Rankings for tournament managers per event', 'href' => BASE_URL . '/admin/tm_ranking.php', 'icon' => 'bi-list-check', 'color' => 'warning'],
