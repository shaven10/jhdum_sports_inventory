        ...
        <table class="entry-form-table">
            ...
            <tbody>
                <tr class="entry-form-photo-row">
                    ...
                    <td>
                        <div class="entry-form-photo-frame">
                            ...
                            <img src="<?= sanitize(UPLOAD_URL_ATHLETES . $athlete['photo']) ?>" alt="<?= sanitize(athleteFullName($athlete)) ?>" class="entry-form-photo">
                            <?php else: ?>
                ...
                <tr class="entry-form-info-row">
                    ...
                    <?php foreach ($rowAthletes as $athlete): ?>
                    <td><?= $athlete ? sanitize(athleteFullName($athlete)) : '' ?></td>
                    <?php endforeach; ?>
                </tr>
                <tr class="entry-form-info-row">
